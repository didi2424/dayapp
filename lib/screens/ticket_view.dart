    ...
    return SizedBox(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Container(
              decoration: BoxDecoration( //decoration BoxDecoration untuk merubah tampilan container
                                ...
                                child: LayoutBuilder(
                                  builder: (BuildContext context, BoxConstraints constraints) {
                                    ...
                                    return Flex(
                                      ...
                                      //     (index) => Text("-")),
                                      children: List.generate(
                                          (constraints.constrainWidth() / 6).floor(), //menghitung jarak antara dua object oleh constrainWidth kemudian text digenerate sesuai jarak yang dihitung
                                          (index) => SizedBox(width: 3,height: 1,
                                                child: DecoratedBox( 
