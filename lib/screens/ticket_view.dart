                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: LayoutBuilder(
                          builder: (BuildContext context,
                            ...
                            print(
                                "the width screen is ${constraints.constrainWidth()}"); //untuk menghitung jarak width container/ dan lainnya
                            return Flex(
                      ...
                      Text(
                        ...
                        style: Styles.headLineStyle3.copyWith(
                            color: Colors
                                .white), //parameters copyWith pada style mememberikan grant untuk menganti warna
                      )
                    ],
                  )
                ],
